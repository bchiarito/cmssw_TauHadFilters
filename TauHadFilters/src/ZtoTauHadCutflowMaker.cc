// -*- C++ -*-
//
// Package:    TauHadFilters/ZtoTauHadCutflowMaker
// Class:      ZtoTauHadCutflowMaker
// 
/**\class ZtoTauHadCutflowMaker ZtoTauHadCutflowMaker.cc TauHadFilters/ZtoTauHadCutflowMaker/plugins/ZtoTauHadCutflowMaker.cc
...
// class declaration
//
class ZtoTauHadCutflowMaker : public edm::one::EDAnalyzer<edm::one::SharedResources> {
   public:
      explicit ZtoTauHadCutflowMaker(const edm::ParameterSet&);
      ~ZtoTauHadCutflowMaker();
  ...
  cfg_isoCut(iConfig.getUntrackedParameter<double>("isoCut"))
{
  ...
  tree_ = fs->make<TTree>("tree","ZtoTauHadCutflowMakerTree");
  // event wide
...
// destructor
//
ZtoTauHadCutflowMaker::~ZtoTauHadCutflowMaker()
{
}

// ------------ method called on each new Event  ------------
void
ZtoTauHadCutflowMaker::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  // get event content
  ...
  // cutflow branches
  bpassMuonTrigger = passMuonTrigger;
...
DEFINE_FWK_MODULE(ZtoTauHadCutflowMaker);
